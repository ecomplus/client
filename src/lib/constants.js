...
export const API_PASSPORT = 'https://passport.e-com.plus/v1/:id/'
...
export const API_PLATFORM = 'https://e-com.plus/api/v1/'
export const API_PLATFORM_CACHE = 'https://io.ecvol.com/api/v1/'
